...
public static class RadiationOptimization{
     ...
     */
    private static bool IsVisible(GrainSquare startSquare, GrainSquare targetSquare, (int X, int Y) direction, List<GrainSquare> visibleSquares) {
        int steps = Math.Max(
     ...
     */
    private static void RetraceSquares(GrainSquare square, List<GrainSquare> allSquares, int maxDepth) {
